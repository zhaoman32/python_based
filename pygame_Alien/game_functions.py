...
def check_play_events(ai_settings, screen, stats, play_button, ship, aliens, bullets,  mouse_x, mouse_y):
...
def check_events(ai_setting, screen, stats, play_button, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_events(ai_setting, screen, stats, play_button, ship, aliens, bullets,  mouse_x, mouse_y)
